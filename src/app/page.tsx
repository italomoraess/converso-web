        ...
        <div className={s.platforms}>
          <Link className={s.pcard} href="/login">
            ...
            <div className={s.pbody}>
              <span className={s.ptype}>⬢ No navegador</span>
              <h2>Painel completo no desktop</h2>
              <p className={s.desc}>Dashboard, funil com arrastar-e-soltar, tabela de serviços e calendário do mês — tudo numa tela só.</p>
              <div className={s.feat}>
                <span className={s.chip}>Dashboard</span>
                <span className={s.chip}>Funil drag &amp; drop</span>
                <span className={s.chip}>Painel de equipe</span>
              </div>
          ...
          <Link className={s.pcard} href="/login">
            ...
            <div className={s.pbody}>
              <span className={s.ptype} style={{ color: 'var(--stage-contato)' }}>▸ No seu bolso</span>
              <h2>App mobile para o dia a dia</h2>
              <p className={s.desc}>Agenda, funil e novos agendamentos na palma da mão — perfeito para atender entre um cliente e outro.</p>
              <div className={s.feat}>
                <span className={s.chip}>Agenda</span>
                <span className={s.chip}>Funil</span>
                <span className={s.chip}>Ação rápida</span>
              </div>
